	...
	<div class="card-body">
		...
		<div class="table-responsive">
			<table class="table table-hover table-striped table-bordered">
				...
				<tr>
					<th>#</th>
					<th>Nama Buah & Jenis Buah</th>
					<th width="500px">Deskripsi Buah <span class="text-white">dbncksbvkdsjkvsjvsjjbjvhbfjvbjdbncksbvkdsjkvsjvsjjbjvhbfjvbj</span>
					</th>
					<th>Foto Buah</th>
<!--					<th>Kandungan Buah</th>-->
<!--					<th>manfaat Buah</th>-->
<!--					<th>Klasifikasi Buah</th>-->
<!--					<th>Sub Klasifikasi Buah</th>-->
					<th>Action</th>
				</tr>
				</thead>
				<tbody>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="nama" class="form-control" placeholder="Masukkan nama buah.."
									   required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="jenis" class="form-control" placeholder="Masukkan jenis buah"
									   required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="">Foto Buah</label>
